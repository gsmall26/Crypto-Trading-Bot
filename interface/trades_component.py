...
class TradesWatch(tk.Frame):
    ...
    def add_trade(self, trade: Trade):
        ...
        #exchange
        self.body_widgets['exchange'][t_index] = tk.Label(self._table_frame, text=trade.contract.exchange.capitalize(), bg=BG_COLOR, fg=FG_COLOR_2, font=GLOBAL_FONT)
        ...
        #side
        self.body_widgets['side'][t_index] = tk.Label(self._table_frame, text=trade.side.capitalize(), bg=BG_COLOR, fg=FG_COLOR_2, font=GLOBAL_FONT)
